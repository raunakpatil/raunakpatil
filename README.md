...
| Project | Stack | Link |
|--------|-------|------|
| **Raunak's ResRescue** · Free AI-powered desktop app that rewrites your resume to beat Applicant Tracking Systems (ATS), generates project ideas, and exports instantly to pixel-perfect PDF & DOCX | `React 18` `Electron` `Google Gemini API` `Vite` `Tailwind CSS` `Framer Motion` | [→ Repo](https://github.com/raunakpatil/Resrescue-ats-resume-optimizer) · [⬇ EXE](https://github.com/raunakpatil/Resrescue-ats-resume-optimizer/releases/latest) |
